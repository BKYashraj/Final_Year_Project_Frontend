  ...
  <>
    ...
    <div className="space-y-4" >
      ...
      <div className="border rounded-lg p-4">
        <label className="block text-sm font-medium text-gray-900 mb-2">Select Types of Crops Used</label>
        {['Sugarcane', 'Maize', 'Sorghum', 'Wheat', 'Barley', 'Corn', 'Banana Pseudo Stem'].map((crop) => (
          <div key={crop} className="flex items-center gap-2">
            ...
            <label className="text-gray-900">{crop}</label>
          </div>
        ))}
      </div>
...
{signUpState.role === "Factory" && (
            <>
            <div className="space-y-4">
            <label className="block text-sm font-medium text-gray-900">Factory Name <span className="text-red-500">*</span>
            ...
            <label className="block text-sm font-medium text-gray-900">Factory Address <span className="text-red-500">*</span>
            ...
            <label className="block text-sm font-medium text-gray-900">Contact Person Name <span className="text-red-500">*</span>
          ...
          <label className="block text-sm font-medium text-gray-900">Contact Number <span className="text-red-500">*</span>
          ...
          <label className="block text-sm font-medium text-gray-900">Email ID <span className="text-red-500">*</span>
          ...
          <label className="block text-sm font-medium text-gray-900">Password <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Confirm Password <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Factory Registration Number <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">GST Number <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Target Production (in tons) <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Previous Year Production (in tons) <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Storage Capacity (in tons) <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Number of Existing Farmers <span className="text-red-500">*</span>
...
{signUpState.role === "Distributor" && (
  <>
    <div className="space-y-4">
      <label className="block text-sm font-medium text-gray-900">Distributor Name <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Distributor Address <span className="text-red-500">*</span>
    ...
    <label className="block text-sm font-medium text-gray-900">Contact Person Name <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Distributor Registration Number <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Monthly Ethanol Requirement (in liters/tons) <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Licenses & Compliance Approvals (Excise License, Pollution Control, etc.) <span className="text-red-500">*</span>
      ...
      <label className="block text-sm font-medium text-gray-900">Number of Existing Factories <span className="text-red-500">*</span>
    ...
    <label className="block text-sm font-medium text-gray-900">Products Requiring Ethanol <span className="text-red-500">*</span></label>
      ...
      <label className="block text-sm font-medium text-gray-900">Preferred Ethanol Type<span className="text-red-500">*</span></label>
      <div className="grid grid-cols-2 gap-2">
      {["Anhydrous", "Hydrous", "Bioethanol", "Synthetic Ethanol", "Denatured Ethanol", "Rectified Spirit", "Absolute Ethanol", "Fuel Ethanol"].map((type) => (
          ...
          <button type="submit" className="w-full px-8 py-3 text-lg text-white bg-orange-500 rounded-lg hover:bg-yellow-700">Create Account</button>
        </form>
